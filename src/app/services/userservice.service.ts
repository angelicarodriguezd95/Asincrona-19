...
export class UserserviceService {
  ...
  apiUser = environment.apiURL+ 'films/';
  apiasincrona19= environment.apiURL + "posts/"
...
//Interceptor
getasincrona19():Observable<any>{
  return this.http.get(this.apiasincrona19,{observe:"response"})
}
}
